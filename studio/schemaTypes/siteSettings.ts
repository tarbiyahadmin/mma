...
export const siteSettings = defineType({
  ...
  type: 'document',
  title: 'Site Settings',
  groups: [{ name: 'seo', title: 'Sitewide SEO' }, { name: 'nav', title: 'Navigation' }, { name: 'footer', title: 'Footer' }],
  fields: [
    defineField({ name: 'metaTitle', type: 'string', title: 'Meta Title', group: 'seo' }),
    defineField({ name: 'metaDescription', type: 'text', title: 'Meta Description', group: 'seo', rows: 3 }),
    defineField({
      name: 'navLinks',
      type: 'array',
